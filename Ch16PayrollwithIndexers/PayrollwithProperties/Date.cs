...
namespace PayrollwithIndexers
{
    public class Date
    {
        ...
        public int this[string index] // indexer for dates using "mo", "dy", "yr"
        {
            get
            {
                switch (index)
                {
                    case "mo": return _month;
                    case "dy": return _day;
                    case "yr": return _year;
                    default: return -1;
                }
            }
            set
            {
                switch (index)
                {
                    case "mo": _month = value; break;
                    case "dy": _day = value; break;
                    case "yr": _year = value; break;
